        ...
        <div class="ratings-content">
            <div class="overview">
                ...
                <div class="overview-right">
                    <div class="score-wrapper">
                        ...
                        <Star :score="info.serviceScore" :size="36" class="star"/>
                        <span class="score">{{info.serviceScore}}</span>
                    </div>
                    <div class="score-wrapper">
                        <div class="title">商品评分</div>
                        <Star :score="info.foodScore" :size="36" class="star"/>
            ...
            <div class="ratingselect">
                ...
                <div class="switch" :class="{on:onlyShowText}" @click="toggleOnlyShowText">
                    <span class="iconfont icon-duigou" v-if="onlyShowText"></span>
                ...
                <ul>
                    <li class="rating-item" v-for="(rating, index) in filterRatings" :key="index">
                        ...
                        <div class="content">
                            ...
                            <div class="recommend">
                                <span class="iconfont" :class="rating.rateType?'icon-icon-thumb_down':'icon-icon-thumb_up'"></span>
            ...
            .rating-item
                ...
                .content
                    ...
                    .recommend
                        ...
                        .item
                            padding 0 6px
                            border 1px solid red rgba(7,17,27,0.1)
                            border-radius 1px
                            color rgb(147,153,159)
                            background #fff
                    .time
